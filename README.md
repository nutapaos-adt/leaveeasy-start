...
🌐 **เว็บออนไลน์:** https://leaveeasy-nutapao.web.app
...
> 💡 **ทุกหน้ารวมถึง `leave-requests.html` ดับเบิลคลิกเปิดตรงๆ ได้ตามปกติ** — ต่อกับ Firestore จริง
> แล้ว (ตั้งแต่สัปดาห์ที่ 6) โดยใช้ Firebase SDK แบบ "compat" (สคริปต์ธรรมดา ไม่ใช่ ES module)
> จึงไม่ติดปัญหาเบราว์เซอร์บล็อกการเปิดผ่าน `file://` เหมือน SDK แบบใหม่
